    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-body">
                ...
                <h1 align="center">Cập nhật</h1>
<form action="{{route('book.update',[$data->id])}}" method="POST" role="form" enctype="multipart/form-data">
    @method('PUT')
    @csrf
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="title" name="title" value="{{$data->title}}" placeholder="Tên sách...">
        <label for="author">Tác giả</label>
        <input type="text" name="author" id="author" class="form-control" value="{{$data->author}}" title="" placeholder="Tên tác giả...">
        <label for="publisher">Nhà xuất bản</label>
        <input type="text" name="publisher" id="publisher" class="form-control" value="{{$data->publisher}}" title="" placeholder="Tên tác giả...">
        <div class="form-group">
            <label for="category" class="control-label">Thể loại :</label>
            <div class="col-sm-12" id="category-data"></div>
        </div>
        <div class="form-group">
            <label for="storage" class="control-label">Kho sách :</label>
            <div class="col-sm-12" id="storage-data"></div>
        </div>
        <label for="avatar">Ảnh</label>
        <input type="file" class="form-control" id="avatar" name="avatar" />
        <div>
            <img  class="card-img" alt="..." id="add-avatar" src="images/books/{{$data->avatar}}" style="max-width: 100px;">
        </div>
        <label for="number">Số lượng:</label>
        <input type="number" class="form-control" id="number" name="number" placeholder="Số lượng..." value="{{$data->number}}"/>

        <label for="price">Giá tiền:</label>
        <input type="text" class="form-control" id="price" name="price" placeholder="Giá tiền..." value="{{$data->price}}"/>
         <label for="isbn">ISBN:</label>
        <input type="text" class="form-control" id="isbn" name="isbn" placeholder="ISBN..." value="{{$data->isbn}}">
        <div class="form-group">
