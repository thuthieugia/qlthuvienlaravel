 ...
 <!-- ============================================================== -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xlg-3">
                        <!-- Column -->
                        <div class="card">
                            <img class="card-img-top" src="images/background/profile-bg.jpg"
                                alt="Card image cap">
                                ...
                                <div class="message-box contact-box">
                                    ...
                                    <div class="message-widget contact-widget">
                                        ...
                                        <a href="#" class="d-flex align-items-center">
                                            <div class="user-img mb-0"> <img src="images/users/1.jpg"
                                        ...
                                        <!-- Message -->
                                        <a href="#" class="d-flex align-items-center">
                                            <div class="user-img mb-0"> <img src="images/users/2.jpg"
                                                    alt="user" class="img-circle"> <span
                                        ...
                                        <!-- Message -->
                                        <a href="#" class="d-flex align-items-center">
                                            <div class="user-img mb-0"> <img src="images/users/4.jpg"
                                                    alt="user" class="img-circle"> <span
                                ...
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    <div class="card-body">
                                        <div class="profiletimeline border-start-0">
                                            <div class="sl-item">
                                                <div class="sl-left"> <img src="images/users/1.jpg" alt="user"
                                                    ...
                                                    <div><a href="#" class="link">John Doe</a> <span class="sl-date">5
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-6 mb-3"><img
                                                                    src="images/big/img1.jpg" alt="user"
                                                                    class="img-responsive radius w-100"></div>
                                                            <div class="col-lg-3 col-md-6 mb-3"><img
                                                                    src="images/big/img2.jpg" alt="user"
                                                                    class="img-responsive radius w-100"></div>
                                                            <div class="col-lg-3 col-md-6 mb-3"><img
                                                                    src="images/big/img3.jpg" alt="user"
                                                                    class="img-responsive radius w-100"></div>
                                                            <div class="col-lg-3 col-md-6 mb-3"><img
                                                                    src="images/big/img4.jpg" alt="user"
                                                                    class="img-responsive radius w-100"></div>
                                                        </div>
                                            ...
                                            <hr>
                                            <div class="sl-item">
                                                <div class="sl-left"> <img src="images/users/2.jpg" alt="user"
                                                        class="img-circle"> </div>
                                                <div class="sl-right">
                                                    <div> <a href="#" class="link">John Doe</a> <span class="sl-date">5
                                                            minutes ago</span>
                                            ...
                                            <hr>
                                            <div class="sl-item">
                                                <div class="sl-left"> <img src="images/users/4.jpg" alt="user"
                                                        class="img-circle"> </div>
                                                <div class="sl-right">
                                                    <div><a href="#" class="link">John Doe</a> <span class="sl-date">5
                                                            minutes ago</span>
